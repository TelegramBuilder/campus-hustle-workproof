...
const DEMO_ACCOUNTS = [
  ...
  { username: 'chiamaka', label: 'Campus ambassador', desc: 'Chiamaka — ambassador HQ: recruit, help, earn rewards', icon: <IconShield size={16} />, bg: 'linear-gradient(135deg,#7c3aed,#5b21b6)' },
