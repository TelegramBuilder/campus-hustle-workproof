...
export function buildSeed(): AppState {
  ...
  const businesses: StudentBusinessProfile[] = [
    { id: 'biz_funmi', userId: 'u_funmilayo', businessName: 'Funmi’s Fashion Corner', category: 'Fashion & merch', bio: 'Custom-print tees, hoodies and campus merch delivered around UNILAG. I pay verified promoters per confirmed sale or lead.', services: ['Custom-print tees', 'Hoodies & sweatshirts', 'Campus merch bundles'], evidenceNote: 'Instagram @funmisfashion — 400+ followers, 90+ confirmed orders.', status: 'approved', createdAt: ago(75 * DAY) },
    { id: 'biz_dami', userId: 'u_damilola', businessName: 'Dami’s Design Studio', category: 'Design & creative studio', bio: 'Brand kits, posters and social content for student businesses and campus events.', services: ['Brand kits', 'Poster + social sets', 'Event key visuals'], evidenceNote: 'Portfolio on Behance + 12 client groups served.', status: 'approved', createdAt: ago(80 * DAY) },
    { id: 'biz_segun', userId: 'u_segun', businessName: 'New Hall Events Co', category: 'Events & entertainment', bio: 'Open mics, game nights and hall-week experiences. Tickets sold by student promoters with a code on every purchase.', services: ['Open mic nights', 'Game nights', 'Hall-week experiences'], evidenceNote: 'Ran 3 paid events last semester with full halls.', status: 'approved', createdAt: ago(70 * DAY) },
    { id: 'biz_kunbi', userId: 'u_kunbi', businessName: 'Kunbi’s Study Kits', category: 'Books & study materials', bio: 'Revision packs, past-question compilations and stationery bundles for science courses.', services: ['Revision packs', 'Past-question compilations', 'Stationery bundles'], evidenceNote: 'Sales ledger from two revision cohorts.', status: 'approved', createdAt: ago(60 * DAY) },
    { id: 'biz_taiwo', userId: 'u_taiwo', businessName: 'Taiwo’s Proofing Desk', category: 'Campus services', bio: 'Proofreading and document formatting for projects, reports and proposals.', services: ['Proofreading', 'Document formatting', 'CV reviews'], evidenceNote: 'Two sample reports attached.', status: 'pending', createdAt: ago(2 * DAY) },
  ];
